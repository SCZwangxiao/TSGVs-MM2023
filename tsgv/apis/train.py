...
from ..core import (DistEvalHook, EvalHook, DatasetRegenerateHook)
...
def train_model(model,
    ...
    if multigrid_cfg is not None:
        from tsgv.utils.multigrid import LongShortCycleHook
        ...
        from tsgv.utils.multigrid import SubBatchNorm3dAggregationHook
    ...
    if cfg.get('dataset_regenerate', False):
        dataset_regenerate_hook = DatasetRegenerateHook()
        runner.register_hook(dataset_regenerate_hook, priority='LOWEST')
