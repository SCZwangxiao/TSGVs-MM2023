...
from tsgv.datasets import build_dataloader, build_dataset
from tsgv.models import build_model
from tsgv.utils import register_module_hooks, setup_multi_processes

# TODO import test functions from mmcv and delete them from ilearnTSGV
try:
    from mmcv.engine import multi_gpu_test, single_gpu_test
except (ImportError, ModuleNotFoundError):
    warnings.warn(
        'DeprecationWarning: single_gpu_test, multi_gpu_test, '
        'collect_results_cpu, collect_results_gpu from ilearnTSGV will be '
        'deprecated. Please install mmcv through master branch.')
    from tsgv.apis import multi_gpu_test, single_gpu_test


def parse_args():
    parser = argparse.ArgumentParser(
        description='ilearnTSGV test (and eval) a model')
