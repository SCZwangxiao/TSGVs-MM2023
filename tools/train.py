...
from tsgv import __version__
from tsgv.apis import init_random_seed, train_model
from tsgv.datasets import build_dataset
from tsgv.models import build_model
from tsgv.utils import (collect_env, get_root_logger,
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        # save ilearnTSGV version, config file content and class names in
